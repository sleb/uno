 ...
 *
 * This document shows how to migrate existing error handling from string-based
 * to code-based error handling.
 *
 * ## Three Key Scenarios
 *
...
// This file is purely documentation. No runtime code.
